# 📱 OLX iPhone Deal Scraper & Monitor
    ...
    An automated web scraping pipeline built in Python that monitors the OLX marketplace for underpriced iPhones and
  sends real-time alert notifications directly to a Discord server.
    ...
    * **Duplicate Prevention:** Tracks previously scraped listings in `linki.txt` to ensure alerts are only sent for
  new listings.
